...
export const sectionColor = (firstC: colorObject | undefined, secondC: colorObject | undefined, thirdC: colorObject | undefined, value: number) => {
    // TODO: napraviti funkcije koje ce racunati po sledecoj formuli boje 
    // firstColor.boja + procenat((5*broj stepeni)/100) * (secondColor.boja - firstColor.boja)
